...
const char* const flickcurl_short_copyright_string = "Copyright 2007-2012 David Beckett.";

const char* const flickcurl_copyright_string = "Copyright (C) 2007-2012 David Beckett - http://www.dajobe.org/";
